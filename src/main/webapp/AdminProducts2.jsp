...
<div class="table">
	...
	<th>&nbsp Delete</th>
		...
		out.println("<h1><u>Hello "+ab.getaFname()+" , these are the products deatils.</u></h1><br><br>");
		if(al.size()>0)
		{
			...
			while(i.hasNext())
			{
				...
				out.println("<td>&nbsp"+pb.getpQuantity()+"</td>");
...
<a style="font-size: 20px; color:white;" href="AdminHome.jsp">Back to Home</a>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
